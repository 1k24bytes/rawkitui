...
export const Kbd = React.forwardRef<HTMLElement, KbdProps>(
  ({ className, size = 'md', ...props }, ref) => (
    <kbd
      ref={ref}
      className={cn(
        'inline-flex items-center justify-center gap-1 rounded-lg bg-rk-surface font-mono font-bold text-rk-ink rk-border-sm rk-shadow-sm select-none whitespace-nowrap',
